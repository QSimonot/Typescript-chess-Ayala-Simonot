...
let GameController = class GameController extends tsoa_1.Controller {
    ...
    async getGameOfUser(id) {
        return await game_service_1.gameService.getUserGame(id);
    }
    ...
    async addMove(id, requestBody) {
        await game_service_1.gameService.updateMove(id, requestBody.move);
    }
};
...
__decorate([
    (0, tsoa_1.Get)("/user/{id}"),
    (0, tsoa_1.Security)("jwt", ["game:read"]),
    __param(0, (0, tsoa_1.Path)("id")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], GameController.prototype, "getGameOfUser", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], GameController.prototype, "addMove", null);
exports.GameController = GameController = __decorate([
    (0, tsoa_1.Route)("games"),
    (0, tsoa_1.Tags)("Games")
], GameController);
